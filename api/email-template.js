...
<style>
  ...
  html, body, div, table, td, th { background-color: #080810 !important; }
  .card { background-color: #0c0c18 !important; }
</style>
</head>
<body bgcolor="#080810" style="margin:0;padding:0;background-color:#080810 !important;font-family:'DM Mono','SFMono-Regular',Consolas,monospace;">
<div style="background-color:#080810 !important;padding:40px 16px;">
  <table width="100%" cellpadding="0" cellspacing="0" bgcolor="#080810" style="background-color:#080810 !important;max-width:520px;margin:0 auto;">

    <!-- Text logo -->
    <tr><td align="center" bgcolor="#080810" style="background-color:#080810 !important;padding-bottom:32px;">
      <div style="font-family:'Playfair Display',Georgia,serif;font-weight:900;font-size:22px;color:#fff;letter-spacing:-0.5px;line-height:1;">POINTS</div>
      <div style="font-family:'DM Mono','SFMono-Regular',Consolas,monospace;font-size:9px;color:#555566;letter-spacing:4px;text-transform:uppercase;margin-top:3px;">are bad</div>
    </td></tr>

    <!-- Card -->
    <tr><td class="card" bgcolor="#0c0c18" style="background-color:#0c0c18 !important;border:1px solid #1a1a26;border-radius:12px;padding:36px 36px 32px;">
      ...
      <table cellpadding="0" cellspacing="0" style="margin-top:32px;">
        <tr><td bgcolor="#f59e0b" style="background-color:#f59e0b !important;border-radius:8px;">
    ...
    <!-- Footer -->
    <tr><td align="center" bgcolor="#080810" style="background-color:#080810 !important;padding-top:24px;">
